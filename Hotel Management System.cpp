...
class Room
{
	...
	int status;			//ROOM IS BOOKED OR NOT
public:
	friend class Hotel;
...
class Hotel
{
	...
	int nroom, ncust;	//NO OF ROOMS AND CUSTOMERS
public:
	Hotel():nroom(0),ncust(0)
	{}
...
void Hotel::addRooms()
{
	...
	for(int i=0;i<nroom;i++)
	{
		...
		for(int j=0; i<nroom;j++)	//VALIDATIONS FOR REPETITIVE ROOM NUMBERS
		{
